		...
		<section id="about" class="section-content">
			<div class="container">
				...
				<div class="section-title text-center">
					...
					<div>
						<span class="line"></span>
						<span>We create new ground</span>
						<span class="line"></span>
					</div>
					<p class="lead">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="element-line">
							<div class="item_left">
								<img src="public/images/devices.jpg" class="img-responsive img-center" alt="">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="element-line">
							<div class="item_left">
								<div class="media">
									<a class="pull-left rotate" href="#"> <img class="media-object img-circle" src="public/images/about1.jpg" alt=""> </a>
					...
					<div class="col-md-6">
						<div class="element-line">
							<div class="item_right">
								<div class="media">
									<a class="pull-left rotate" href="#"> <img class="media-object img-circle" src="public/images/about2.jpg" alt=""> </a>
									<div class="media-body">
								...
								<ul class="slides">
									...
									<li>
										<div class="slide-item">
											<div class="row">
												<div class="col-md-7">
													<img class="img-responsive img-center img-rounded" src="public/images/service1.jpg" alt=""/>
												</div>
												<div class="col-md-5">
									...
									<li>
										<div class="slide-item">
											<div class="row">
												<div class="col-md-7">
													<img class="img-responsive img-center img-rounded" src="public/images/service2.jpg" alt=""/>
												</div>
												<div class="col-md-5">
